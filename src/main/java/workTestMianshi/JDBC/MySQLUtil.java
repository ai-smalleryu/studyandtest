...
public class MySQLUtil {
    ...
    public static <T> List<T> queryList(String sql, Class<T> clz, boolean underScoreToCamel) {
        ...
        try {
            ...
            conn = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/stu?characterEncoding=utf-8&useSSL=false",
                "root",
                "root@1q2w3e");
            //创建数据库操作对象
    ...
    public static void main(String[] args) {
        ...
        List<StudentTE> list = queryList("select * from studentte", StudentTE.class, true);
        for (StudentTE tableProcess : list) {
